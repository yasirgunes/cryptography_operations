...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!isAlgorithmExit) {
            System.out.println(YELLOW + "Select Algorithm:" + RESET);
            ...
            while (!isExit) {
                System.out.println(YELLOW + "What operation do you want to implement? (Current Algorithm: " + (algorithmChoice == 1 ? "RSA" : "ECC") + ")" + RESET);
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            System.out.println(GREEN + "Encrypted Data:" + RESET);
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            System.out.println(GREEN + "Decrypted Data:" + RESET);
                    ...
                    case 4:
                        ...
                        try {
                            ...
                            System.out.println(GREEN + "Signature:\n" + RESET + Base64.toBase64String(signature));
                        } catch (Exception e) {
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            System.out.println(GREEN + "Signature Verified: " + isVerified + RESET);
                        } catch (Exception e) {
